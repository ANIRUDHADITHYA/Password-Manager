...
while True:
    ...
    try:
        ...
        connection=mysql.connector.connect(user="root",password=""+sql_pass+"",host=""+host+"")
        mycur=connection.cursor()
        break
    except mysql.connector.Error:
        input("Incorrect Password or Host!!! \nPress Any Key to Try Again")
        continue
while True:
    os.system("cls")
    print("*************************************************************************************************************************************************************************")
    ...
    try:
        ...
        if cre_acc==1:
            ...
            try:              
                connection=mysql.connector.connect(user="root",password=""+sql_pass+"",host="localhost",database=""+database+"")
                mycur=connection.cursor()
            ...
            try: 
                ...
                try:
                    ...
                    mycur.execute(pass_db)
                    connection.commit()
                    print("Thank You for Choosing Password Manager\nYour Account for Password Manager has been Created Sucessfully :) ")
                ...
                if data==data1:
                    ...
                    while True:
                        ...
                        try:
                            ...
                            if set_choice==1:
                                new_pass=stdiomask.getpass(prompt='Enter your New Password: ', mask='*')
                                mycur.execute("update pass_db set password='"+new_pass+"' where user_choice=1")
                                connection.commit()
                                input("Sucessfully Updated :)")
                            elif set_choice==2:
                                input("Press Enter to Continue\n***Note Your Password of Your Account will be Deleted Completly\n   and Automatically your Passwords will be Saved in Text File")
